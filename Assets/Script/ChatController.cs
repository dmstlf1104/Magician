...
public class ChatController : MonoBehaviour
{
    ...
    {
        yield return StartCoroutine(NormalChat("스토리", "오랜 세월 해적들 사이에 전해 내려오던 신의 유적이라 불리는 지도가 드디어 발견되었다."));
        ...
        yield return StartCoroutine(NormalChat("스토리", "바로 그 탑은 전설적인 대마법사가 은둔하며 살고 있는 곳이었던 것이다.  "));
